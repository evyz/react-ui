        ...
        <Row>
          ...
          <Cell size={5}>
            ...
            {Object.keys(labelOptions).map((key) =>
              typeof labelOptions[key] === "boolean" ? (
                <Checkbox
                  value={labelOptions[key]}
                  onClick={() => {
...
const InputSlide = () => {
  ...
  const [types, setTypes] = useState(["default", "calendarpicker"]);
              ...
              {types &&
                ...
                types.map((value) => (
                  <Button
                    ...
                    customValidationToDisable={type !== value}
                  >
                    {value}
                  </Button>
                ))}
          ...
          <Cell size={5}>
            ...
            >
              <Calendar
                ...
                rules={{ enableRage: rangeOptions?.enableRange }}
                date={date}
                onChangeDate={(date) => setDate(date)}
                typeRender={"month"}
                monthToShow={monthToShow}
                onChangeMonthHandler={(date) => setMonthToShow(date)}
              />
            </Fieldset>
          </Cell>
          <Cell size={5}>
    ...
    <Wrapper>
      <Row>
        <Cell>
          ...
          <Row>
            <Button
              customValidationToDisable={activeComponent !== 0}
            ...
            <Button
              customValidationToDisable={
                activeComponent < components.length - 1
              }
              onClick={() => setActiveComponent(activeComponent + 1)}
            >
              Next
      ...
      <Row>{components[activeComponent]}</Row>
    </Wrapper>
  );
};
